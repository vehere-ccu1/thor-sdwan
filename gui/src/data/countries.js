 ...
 * Used for country dropdown with flag icons.
 */
export const countries = [
  ...
  { code: 'CD', name: 'Congo (Democratic Republic)' }, { code: 'CR', name: 'Costa Rica' }, { code: 'HR', name: 'Croatia' },
...
/** Get flag emoji from ISO 3166-1 alpha-2 code (e.g. "US" -> 🇺🇸) */
