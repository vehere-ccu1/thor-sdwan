...
FROM (
    SELECT u.id, u.email, u.name, u.account_id, u.entity_id, u.is_owner, u.enabled, u.created_at, u.updated_at,
...
-- View: organizations with account and group (one JOIN per level for ClickHouse 18.x)
